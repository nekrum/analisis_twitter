...
figPath = system.file("/home/daniel/Descargas/klipartz.png",package = "wordcloud2")
wordcloud2(d_2016_2021, figPath = "/home/daniel/Descargas/peaceAndLove.jpg", size = 1.5, color = "skyblue", backgroundColor="black")
...
wordcloud2(data=emo_negativas_2016_2021, size=1.6)

letterCloud(emo_negativas_2016_2021, word = "ACOSO", color='random-light' , backgroundColor="black")
